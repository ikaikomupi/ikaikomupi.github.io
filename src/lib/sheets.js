...
export async function fetchPosts() {
  ...
  try {
    ...
    return data.map((row) => ({
      ...
      penulis: row.penulis || "Tim IKA IKOM UPI 2018",
      tanggal: row.tanggal || "",
